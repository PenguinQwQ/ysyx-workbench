...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
 ...
 // INSTPAT("??????? ????? ????? 000 ????? 00100 11", li     , I, R(rd) = imm); //load immediate number, to be tested....
  ...
  INSTPAT("??????? ????? ????? 010 ????? 00100 11", slti,   I, if((sword_t)src1 < (sword_t)imm)
                                                                   R(rd) = 1; 
                                                               else   
                                                                   R(rd) = 0; 
                                                                    ); //set less than immediate
  INSTPAT("??????? ????? ????? 011 ????? 00100 11", sltiu,   I, if((word_t)src1 < (word_t)imm) 
                                                                   R(rd) = 1; 
                                                                else 
                                                                   R(rd) = 0;
                                                                    );
  ...
  INSTPAT("0000000 ????? ????? 010 ????? 01100 11", slt, R  , if((sword_t)src1 < (sword_t)src2) 
                                                                R(rd) = 1; 
                                                              else 
                                                                R(rd) = 0; 
                                                                 );
  
  INSTPAT("0000000 ????? ????? 011 ????? 01100 11", sltu, R  , if((word_t)src1 < (word_t)src2) 
                                                                  R(rd) = 1; 
                                                               else 
                                                                  R(rd) = 0; 
                                                                  );
